...
function enableLogs(debugConfig, context, id) {
  ...
  if (typeof console === 'object' && debugConfig === true || typeof debugConfig === 'object') {
    ...
    try {
      newLogger.log(`Debug logs enabled for "${context}" in hls.js version ${"1.7.0"}`);
    } catch (e) {
...
function getNextFrag(details, sn, fragmentHintForParts) {
  return fragmentHintForParts && sn === details.endSN && details.fragmentHint ? details.fragmentHint : details.fragments[1 + sn - details.startSN] || null;
}
